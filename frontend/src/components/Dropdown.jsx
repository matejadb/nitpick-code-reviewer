  ...
  return (
    <div className="relative" ref={ref}>
      <button
        ...
        className="flex items-center gap-1.5 rounded-md border border-neutral-700 bg-neutral-900 px-2 py-1 text-sm text-white hover:cursor-pointer hover:bg-neutral-800 focus:ring-1 focus:ring-blue-500 focus:outline-none disabled:cursor-not-allowed disabled:bg-neutral-800"
        disabled={disabled}
      >
        {selected?.label}
        <svg
